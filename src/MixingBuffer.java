...
{//used to mix .WAV files together to make new .WAV file
...
//        System.out.println("Normal Male: " + totalMaleNormal + "\n\n");
    ...
    public void synthesise(int numSamples, int duration, int mfRatio, int softVsLoud)
    {//creates the synthesised crowd
        ...
        try
        {
            ...
            Arrays.fill(buffer, 0);//fill buffer with 0's so += works okay
            ...
            byte[] bufferInBytes = converter.intToByteArray(buffer);
